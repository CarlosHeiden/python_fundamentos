4 - Crie uma classe abstrata Animal com um método emitir_som(). 
Crie subclasses Cachorro,Gato, Cavalo e Vaca que herdam de Animal e 
implementam seus próprios sons. Crie uma função
